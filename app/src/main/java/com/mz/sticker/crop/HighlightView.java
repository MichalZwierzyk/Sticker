...
public class HighlightView {
    ...
    protected static final int DEFAULT_HIGHLIGHT_COLOR = 0xFF33B5E5;
    protected static final float HANDLE_RADIUS_DP = 12f;
    protected static final float OUTLINE_DP = 2f;

    protected enum ModifyMode { None, Move, Grow }
    protected enum HandleMode { Changing, Always, Never }

    protected RectF cropRect; // Image space
    protected Rect drawRect; // Screen space
    public Matrix matrix;
    protected RectF imageRect; // Image space

    protected final Paint outsidePaint = new Paint();
    protected final Paint outlinePaint = new Paint();
    protected final Paint handlePaint = new Paint();

    protected View viewContext; // View displaying image
    protected boolean showThirds;
    ...
    protected float initialAspectRatio;
    ...
    protected void initStyles(Context context) {
    ...
    protected void drawThirds(Canvas canvas) {
